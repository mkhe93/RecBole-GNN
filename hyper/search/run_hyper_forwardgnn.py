...
def main():
    ...
    parser.add_argument('--config_files', type=str, default='../parameter_fixed/hyper_forwardgnn_djc100000.yaml', help='fixed config files')
    parser.add_argument('--params_file', type=str, default='../parameter_space/params_forwardgnn.hyper', help='parameters file')
    parser.add_argument('--output_file', type=str, default='./results/forwardgnn-hyper-djc100000.result', help='output file')
